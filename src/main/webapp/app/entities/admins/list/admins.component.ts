...
import { EntityArrayResponseType, AdminsService } from '../service/admins.service';
import { AdminsDeleteDialogComponent } from '../delete/admins-delete-dialog.component';
...
export class AdminsComponent implements OnInit {
  ...
  protected refineData(data: IAdmins[]): IAdmins[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: IAdmins[] | null): IAdmins[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.adminsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
